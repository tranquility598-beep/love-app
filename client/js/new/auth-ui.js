...
(function () {
  ...
  async function initAuth() {
    ...
    const _perfLite = (() => { try { return document.documentElement.classList.contains('perf-lite') || /Android/i.test(navigator.userAgent || ''); } catch (e) { return false; } })();
    if (particles && !_perfLite && !window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
